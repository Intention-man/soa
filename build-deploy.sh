...
eureka-ribbon/target/eureka-ribbon-1.0-SNAPSHOT.jar \
...
scp -r -P 2222 -i ~/.ssh/id_rsa_s367527 \
config-repo \
zuul-proxy/target/zuul-proxy-1.0-SNAPSHOT.jar \
s367527@helios.cs.ifmo.ru:~/services/zuul-proxy-dir
